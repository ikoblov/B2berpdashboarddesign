        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          >
            <div className="flex items-center gap-2 text-sm text-gray-700">
              ...
              <span>Добавить нового доверенного ��МЗ</span>
            </div>
          </button>
        </div>
      </div>
...
function WorkerRow({ 
  ...
  return (
    <div className="border-b border-gray-100 last:border-b-0">
      ...
      >
        <div className="grid grid-cols-[28px_minmax(320px,1fr)_130px_95px_100px_100px_36px] gap-3 items-center">
          {/* Index */}
          <div className="text-[11px] text-gray-500 font-medium">{index + 1}.</div>

          {/* Worker Info + Status + Payment Method in vertical layout */}
          <div className="flex items-start gap-2.5 min-w-0">
            ...
            {/* Name + Worker ID + Badges in vertical stack */}
            <div className="min-w-0 flex-1">
              <button
                onClick={(e) => {
                  e.stopPropagation();
                ...
                className="text-xs text-gray-900 font-medium truncate hover:underline text-left block w-full mb-0.5"
              >
                {worker.name}
              </button>
              <p className="text-[11px] text-gray-500 mb-1.5">{worker.workerId}</p>
              
              {/* Status badges aligned vertically */}
          ...
          <div className="flex items-center gap-1.5">
            ...
            {/* Context Menu (троеточие возле количества смен) */}
          ...
          <div className="text-right">
            {deductionsTotal !== 0 ? (
              <div className="relative group">
                <p className="text-[10px] text-gray-500 mb-0.5">Удержания</p>
                <p className={cn(
            ...
            {canSelect ? (
              ...
              <div className="relative group">
                <input
                  type="checkbox"
                  disabled
                  className="w-3.5 h-3.5 rounded border-gray-300 text-gray-400 cursor-not-allowed opacity-40"
                />
        ...
        <div className={cn(
          ...
          {!worker.paymentMethod && (
            <button
              ...
              className="px-3 py-1.5 rounded-lg text-[11px] font-medium transition-all bg-orange-50 border border-orange-300 text-orange-700 hover:bg-orange-100"
            >
              Нужно распределить
            </button>
          )}
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        <div className="px-3 py-2 border-b border-gray-200 bg-gray-50">
          <div className="flex items-center justify-between">
            ...
            <label className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-[11px] font-medium text-gray-700 hover:bg-gray-100 cursor-pointer transition-colors border border-gray-300">
              <input
                type="checkbox"
