...
export function AutoPlanningScreen() {
  const [selectedObject, setSelectedObject] = useState('oasis');
  ...
  // Mock data - recommended candidates
    ...
    <>
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="px-6 py-4">
          <h1 className="text-gray-900">Автопланирование смен</h1>
        </div>
      </div>

      <div className="p-6">
        
        {/* A) Top bar - filters and actions */}
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3 flex-1">
              ...
              <select
                ...
                className="px-3 py-1.5 border border-gray-300 rounded text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
              >
                <option value="">Роль/специализация</option>
              ...
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="w-16 px-3 py-1.5 border border-gray-300 rounded text-sm text-center focus:outline-none focus:ring-1 focus:ring-blue-500"
                />
            ...
            <div className="flex items-center gap-2">
              ...
              <button className="px-4 py-1.5 bg-green-600 hover:bg-green-700 text-white text-sm rounded-lg transition-colors">
                Назначить выбранных
              </button>
            </div>
          </div>
        ...
        <div className="grid grid-cols-[280px_1fr] gap-4">
          ...
          <div className="space-y-4">
            ...
            {/* D) Rejected candidates - collapsible block */}
          ...
          {/* C) Main table - recommended candidates */}
          <div className="space-y-4">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200">
                ...
                <table className="w-full text-sm">
                  <thead className="bg-gray-50 border-b border-gray-200">
                    <tr>
                      ...
                      <th className="px-3 py-2 text-left text-xs font-medium text-gray-600">Исполнитель</th>
                      <th className="px-3 py-2 text-left text-xs font-medium text-gray-600">Рейтинг</th>
                      <th className="px-3 py-2 text-left text-xs font-medium text-gray-600">Дистанция / район</th>
                      <th className="px-3 py-2 text-left text-xs font-medium text-gray-600">Специализация</th>
                      <th className="px-3 py-2 text-left text-xs font-medium text-gray-600">Статус НПД</th>
